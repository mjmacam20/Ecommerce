                            ...
                            <table id="sectionss" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($section['status']==1)
                                                <a class="updateSectionStatus" id="section-{{ $section['id'] }}" section_id=" {{ $section['id'] }}" href="javascript:void(0)"><i style='font-size: 21px;'class="mdi mdi-checkbox-multiple-marked" status="Active"></i></a>
                                            @else
                                            <a class="updateSectionStatus" id="section-{{ $section['id'] }}" section_id=" {{ $section['id'] }}" href="javascript:void(0)"><i style='font-size: 21px;'class="mdi mdi-checkbox-multiple-blank-outline" status="Inactive"></i></a>
                                            @endif
                                        </td>
                                        <td>
