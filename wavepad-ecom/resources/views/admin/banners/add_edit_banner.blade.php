              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" @if(empty($banner['id'])) action="{{url('admin/add-edit-banner') }}" @else {{url('admin/add-edit-banner/'.$banner['id']) }} @endif method="post" enctype="multipart/form-data">@csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="alt" placeholder="Enter Banner Alternative Text" name="alt" @if(!empty($banner['alt'])) value="{{ $banner['alt'] }}" @else value="{{ old('alt') }}" @endif>
                      </div>
