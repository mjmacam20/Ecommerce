                            ...
                            <table id="products" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($product['status']==1)
                                                <a class="updateProductStatus" id="product-{{ $product['id'] }}" product_id=" {{ $product['id'] }}" href="javascript:void(0)"><i style='font-size: 21px;'class="mdi mdi-checkbox-multiple-marked" status="Active"></i></a>
                                            @else
                                            <a class="updateProductStatus" id="product-{{ $product['id'] }}" product_id=" {{ $product['id'] }}" href="javascript:void(0)"><i style='font-size: 21px;'class="mdi mdi-checkbox-multiple-blank-outline" status="Inactive"></i></a>
                                            @endif
                                        </td>
                                        <td>
